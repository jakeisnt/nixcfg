...
in {
  ...
  config = mkIf cfg.enable {
    ...
    home.configFile = {
      "tmux/config".source = config.lib.file.mkOutOfStoreSymlink "${configDir}/tmux/config";
      "tmux/tmux.conf".source = config.lib.file.mkOutOfStoreSymlink "${configDir}/tmux/tmux.conf";
      "tmux/swap-pane.sh".source = config.lib.file.mkOutOfStoreSymlink "${configDir}/tmux/swap-pane.sh";
      "tmux/extraInit".text = ''
