...
in {
  ...
  config = mkIf cfg.enable {
    ...
    home.configFile = {
      "tmux/config".source = mkOutOfStoreSymlink "${configDir}/tmux/config";
      "tmux/tmux.conf".source = mkOutOfStoreSymlink "${configDir}/tmux/tmux.conf";
      "tmux/swap-pane.sh".source = mkOutOfStoreSymlink "${configDir}/tmux/swap-pane.sh";
      "tmux/extraInit".text = ''
